...
include 'header.php';
?>
<tr><td class="contenthead" colspan="2">Spy Log</td></tr><tr>	<td class="contentcontent">	<table width="100%">
            ...
            $result = DB::run("SELECT * from `spylog` WHERE `id` = '".$user_class->id."' ORDER BY age DESC LIMIT 0,25");
